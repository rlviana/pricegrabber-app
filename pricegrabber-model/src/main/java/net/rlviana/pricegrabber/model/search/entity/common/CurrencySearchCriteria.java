...
/**
 * Search criteria for Currency entites
 * 
 * @author ramon
 */
public class CurrencySearchCriteria extends AbstractSearchCriteria<Currency, String> {
  ...
  protected List<Order> getOrdering(final CriteriaBuilder builder, final Root<Currency> root) {
    ...
    orderBy.add(builder.desc(root.get(Currency_.id)));
    return orderBy;
  }
