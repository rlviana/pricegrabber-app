...
/**
 * <p>Clase Java para createSiteItemResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createSiteItemResponse">
 *   &lt;complexContent>
...
@XmlType(name = "createSiteItemResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "createSiteItemResponse")
public class CreateSiteItemResponse
