...
/**
 * <p>Clase Java para findItemByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="findItemByIdResponse">
 *   &lt;complexContent>
...
@XmlType(name = "findItemByIdResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "findItemByIdResponse")
public class FindItemByIdResponse
