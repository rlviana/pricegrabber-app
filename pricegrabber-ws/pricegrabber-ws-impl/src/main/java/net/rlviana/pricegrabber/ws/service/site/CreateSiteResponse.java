...
/**
 * <p>Clase Java para createSiteResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createSiteResponse">
 *   &lt;complexContent>
...
@XmlType(name = "createSiteResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "createSiteResponse")
