...
/**
 * <p>Clase Java para listSiteItemsResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listSiteItemsResponse">
 *   &lt;complexContent>
...
@XmlType(name = "listSiteItemsResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "listSiteItemsResponse")
public class ListSiteItemsResponse
