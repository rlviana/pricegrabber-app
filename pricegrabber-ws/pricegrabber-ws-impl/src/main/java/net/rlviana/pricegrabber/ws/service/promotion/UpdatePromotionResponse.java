...
/**
 * <p>Clase Java para updatePromotionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updatePromotionResponse">
 *   &lt;complexContent>
...
@XmlType(name = "updatePromotionResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "updatePromotionResponse")
