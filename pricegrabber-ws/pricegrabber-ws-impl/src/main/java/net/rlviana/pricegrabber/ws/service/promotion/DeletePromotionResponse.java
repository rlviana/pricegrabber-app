...
/**
 * <p>Clase Java para deletePromotionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deletePromotionResponse">
 *   &lt;complexContent>
...
@XmlType(name = "deletePromotionResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "deletePromotionResponse")
