...
/**
 * <p>Clase Java para deleteSiteItemDatumResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteSiteItemDatumResponse">
 *   &lt;complexContent>
...
@XmlType(name = "deleteSiteItemDatumResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "deleteSiteItemDatumResponse")
public class DeleteSiteItemDatumResponse
