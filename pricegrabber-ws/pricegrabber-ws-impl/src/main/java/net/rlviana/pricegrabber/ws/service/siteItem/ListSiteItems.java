...
/**
 * <p>Clase Java para listSiteItems complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listSiteItems">
 *   &lt;complexContent>
...
@XmlType(name = "listSiteItems", propOrder = {
    "criteria"
})
@XmlRootElement(name = "listSiteItems")
public class ListSiteItems
