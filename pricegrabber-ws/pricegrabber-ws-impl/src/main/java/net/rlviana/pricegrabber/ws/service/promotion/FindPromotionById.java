...
/**
 * <p>Clase Java para findPromotionById complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="findPromotionById">
 *   &lt;complexContent>
...
@XmlType(name = "findPromotionById", propOrder = {
    "promotionId"
})
@XmlRootElement(name = "findPromotionById")
