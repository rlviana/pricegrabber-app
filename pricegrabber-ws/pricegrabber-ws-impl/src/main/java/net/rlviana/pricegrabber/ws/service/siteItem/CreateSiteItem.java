...
/**
 * <p>Clase Java para createSiteItem complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createSiteItem">
 *   &lt;complexContent>
...
@XmlType(name = "createSiteItem", propOrder = {
    "siteItem"
})
@XmlRootElement(name = "createSiteItem")
public class CreateSiteItem
