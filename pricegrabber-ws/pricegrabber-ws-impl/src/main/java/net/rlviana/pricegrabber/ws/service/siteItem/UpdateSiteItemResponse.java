...
/**
 * <p>Clase Java para updateSiteItemResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updateSiteItemResponse">
 *   &lt;complexContent>
...
@XmlType(name = "updateSiteItemResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "updateSiteItemResponse")
public class UpdateSiteItemResponse
