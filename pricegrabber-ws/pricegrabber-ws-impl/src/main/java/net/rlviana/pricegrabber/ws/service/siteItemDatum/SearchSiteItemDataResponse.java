...
/**
 * <p>Clase Java para searchSiteItemDataResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="searchSiteItemDataResponse">
 *   &lt;complexContent>
...
@XmlType(name = "searchSiteItemDataResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "searchSiteItemDataResponse")
public class SearchSiteItemDataResponse
