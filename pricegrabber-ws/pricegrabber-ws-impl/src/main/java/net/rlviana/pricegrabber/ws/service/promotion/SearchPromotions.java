...
/**
 * <p>Clase Java para searchPromotion complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="searchPromotion">
 *   &lt;complexContent>
...
@XmlType(name = "searchPromotion", propOrder = {
    "criteria"
})
@XmlRootElement(name = "searchPromotions")
public class SearchPromotions
