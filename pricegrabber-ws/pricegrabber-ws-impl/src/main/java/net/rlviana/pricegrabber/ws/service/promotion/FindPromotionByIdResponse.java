...
/**
 * <p>Clase Java para findPromotionByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="findPromotionByIdResponse">
 *   &lt;complexContent>
...
@XmlType(name = "findPromotionByIdResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "findPromotionByIdResponse")
public class FindPromotionByIdResponse
