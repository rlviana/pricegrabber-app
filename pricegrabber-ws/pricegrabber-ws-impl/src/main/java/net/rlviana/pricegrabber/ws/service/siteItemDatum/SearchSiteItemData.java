...
/**
 * <p>Clase Java para searchSiteItemData complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="searchSiteItemData">
 *   &lt;complexContent>
...
@XmlType(name = "searchSiteItemData", propOrder = {
    "criteria"
})
@XmlRootElement(name = "searchSiteItemData")
public class SearchSiteItemData
