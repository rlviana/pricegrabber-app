...
/**
 * <p>Clase Java para updateSiteItemDatumResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updateSiteItemDatumResponse">
 *   &lt;complexContent>
...
@XmlType(name = "updateSiteItemDatumResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "updateSiteItemDatumResponse")
public class UpdateSiteItemDatumResponse
