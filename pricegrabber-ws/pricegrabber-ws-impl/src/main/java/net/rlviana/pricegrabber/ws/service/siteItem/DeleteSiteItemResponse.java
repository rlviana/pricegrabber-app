...
/**
 * <p>Clase Java para deleteSiteItemResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteSiteItemResponse">
 *   &lt;complexContent>
...
@XmlType(name = "deleteSiteItemResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "deleteSiteItemResponse")
public class DeleteSiteItemResponse
