...
/**
 * <p>Clase Java para createSiteItemDatumResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createSiteItemDatumResponse">
 *   &lt;complexContent>
...
@XmlType(name = "createSiteItemDatumResponse", propOrder = {
    "_return"
})
@XmlRootElement(name = "createSiteItemDatumResponse")
public class CreateSiteItemDatumResponse
