...
/**
 * <p>Clase Java para updatePromotion complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updatePromotion">
 *   &lt;complexContent>
...
@XmlType(name = "updatePromotion", propOrder = {
    "promotion"
})
@XmlRootElement(name = "updatePromotion")
